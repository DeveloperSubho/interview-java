...
Q13. What are the differences between Heap and Stack Memory in Java?
...
4. Public
   ...
   methods}
   Q19. What is an object in Java and how is it created?
...
8. Inheritance: Inheritance is a process where one class acquires the properties of another.
9. Encapsulation: Encapsulation in Java is a mechanism of wrapping up the data and code together as a single unit.
10. Abstraction: Abstraction is the methodology of hiding the implementation details from the user and only providing the functionality to the users.
11. Polymorphism: Polymorphism is the ability of a variable, function or object to take multiple forms.
    Q22. What is the importance of reflection in Java?
    ...
    Q23. How to not allow serialization of attributes of a class in Java?
    ...
    Q24. Can you call a constructor of a class inside another constructor?
    ...
    Q25. How is the creation of a String using new() different from that of a literal?
    ...
    Q26. What is the difference between a local variable and an instance variable?
    ...
    Q27. Differentiate between the constructors and methods in Java?
    Methods Constructors
12. Used to represent the behavior of an object 1. Used to initialize the state of an object
13. Must have a return type 2. Do not have any return type
14. Needs to be invoked explicitly 3. Is invoked implicitly
15. No default method is provided by the compiler 4. A default constructor is provided by the compiler if the class has none
16. Method name may or may not be same as class name 5. Constructor name must always be the same as the class name
    ...
    Q28. What is final keyword in Java?
    ...
    Q29. What is the difference between break and continue statements?
    break continue
17. Can be used in switch and loop (for, while, do while) statements 1. Can be only used with loop statements
18. It causes the switch or loop statements to terminate the moment it is executed 2. It doesn’t terminate the loop but causes the loop to jump to the next iteration
19. It terminates the innermost enclosing loop or switch immediately 3. A continue within a loop nested with a switch will cause the next loop iteration to execute
Example break:
1
2
3
...
Q30. What is an infinite loop in Java? Explain with an example.
...
Q31. What is the difference between this() and super() in Java?
...
Q33. Differentiate between static and non-static methods in Java.
...
3. They can’t access any non-static instance variables or methods 3. It can access any static method and any static variable without creating an instance of the class
   Q34. Why is synchronization necessary? Explain with the help of a relevant example.
...
Q35. Explain the term “Double Brace Initialisation” in Java?
...
Q36. Why is it said that the length() method of String class doesn’t return accurate results?
...
2. From base class using super()
   ...
   Q39. What is a classloader in Java?
...
5. System/Application ClassLoader
   ...
   Q41. What is the difference between an array and an array list?
   Array ArrayList
...
6. Map doesn’t contain duplicate keys.
7. Each key can map at max one value.
   Q43. What is collection class in Java? List down its methods and interfaces.
